    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Chào mừng Quý khách đến với Yapee! Tại Yapee, chúng tôi tin rằng mọi người đều xứng đáng được tiếp cận những sản phẩm chất lượng cao mà không cần phải đắn đo về giá cả.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
        ...
        <div>
          <Badge className="mb-4">Sứ mệnh của chúng tôi</Badge>
          <h2 className="text-3xl font-bold mb-4">Yapee cung cấp các sản phẩm chất lượng cao với giá cả phải chăng</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Chúng tôi cam kết mang đến trải nghiệm mua sắm tốt nhất cho khách hàng. 
            "Chất lượng cao" không chỉ nằm ở bản thân sản phẩm mà còn ở quy trình lựa chọn, kiểm định nghiêm ngặt để đảm bảo mỗi mặt hàng đến tay Quý khách đều đạt tiêu chuẩn tốt nhất.
          </p>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            "Giá cả phải chăng" là nỗ lực không ngừng của Yapee trong việc tối ưu hóa vận hành và hợp tác với các nhà cung cấp uy tín, nhằm mang lại giá trị tối đa cho ngân sách của bạn.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Chúng tôi không thỏa hiệp về chất lượng. Từ khâu lựa chọn sản phẩm đến quy trình bảo quản và vận chuyển, chất lượng luôn là ưu tiên hàng đầu.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-bold mb-2">Giá cả Hợp lý</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Chúng tôi cam kết mang đến mức giá cạnh tranh và hợp lý nhất có thể, giúp Quý khách tiết kiệm chi phí mà vẫn sở hữu được sản phẩm ưng ý.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Mọi quyết định và hành động của Yapee đều hướng đến sự hài lòng của khách hàng. Chúng tôi lắng nghe, thấu hiểu và nỗ lực đáp ứng nhu cầu của bạn một cách tốt nhất.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-bold mb-2">Đáng tin cậy</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Chúng tôi xây dựng niềm tin bằng sự minh bạch trong thông tin, sự chuẩn xác trong giao dịch và sự đảm bảo trong cam kết về sản phẩm và dịch vụ.
              </p>
            </CardContent>
          </Card>
        </div>
